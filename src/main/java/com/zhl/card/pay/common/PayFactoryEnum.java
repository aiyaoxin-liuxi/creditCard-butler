package com.zhl.card.pay.common;
...
public enum PayFactoryEnum {
	...
	CASHIERPAY("CASHIERPAY","com.zhl.card.pay.impl.CashierPay","新钱包的接口（在南京写的那个）")
	,CARDVALID_KAOLA("CARDVALID_KAOLA","com.zhl.card.pay.impl.CardValidOfKaoLa","考拉的卡有效性验证")
	;
	private String code;
	private String name;
	private String desc;
