...
public class CardBin implements Serializable {
    ...
    public String toString() {
        return "CardBin [id=" + id + ", createdDate=" + createdDate + ", bankinfoId=" + bankinfoId + ", cardBin="
                + cardBin + ", cardBinLen=" + cardBinLen + ", cardLen=" + cardLen + ", cardBinType=" + cardBinType
                + ", issincCode=" + issincCode + ", issincName=" + issincName + ", cardName=" + cardName + ", state="
                + state + ", createName=" + createName + ", updateDate=" + updateDate + ", updateName=" + updateName
                + ", remark=" + remark + ", isAudit=" + isAudit + "]";
    }
